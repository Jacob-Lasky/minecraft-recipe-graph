...
FIELDS = {
    ...
    # with an ad-hoc script is what this module exists to stop. THE GRAPH'S OWN PREDICATE,
    # not a copy of it: this module used to carry a `_reachable_form` of its own on the
    # reasoning that `api` must not import `solve`, which is a true constraint with a wrong
